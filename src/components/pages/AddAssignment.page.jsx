...
export const AddAssignmentPage = ({ setActivePage }) => (
	<div onClick={() => setActivePage('assignment')} className="z-10 fixed flex-center popup-container">
		<div className="addVideoPopup">
			<div className="flex items-center justify-between mb-73px">
				<div className="addvideo-popup-heading">Add Assignment</div>
				<input
