...
export const AddVideoPage = ({ setActivePage }) => (
	<div onClick={() => setActivePage('video')} className="z-10 fixed flex-center popup-container">
		<div className="addVideoPopup">
			<div className="flex items-center justify-between mb-73px">
				<div className="addvideo-popup-heading">Add video</div>
				<input
